...
export function Footer() {
  return (
    <footer className="bg-[#1E3A8A] text-white py-16 px-6 md:px-12 lg:px-24 mt-auto">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        {/* Logo and Description */}
        <div className="space-y-6">
          <h2 className="text-2xl font-bold tracking-tight text-white">Global Leadership Makers</h2>
          <p className="text-[#1E3A8A]/20 text-indigo-200/80 max-w-sm leading-relaxed">
        ...
        <div className="space-y-6">
          ...
          <div className="flex space-x-4 pt-4">
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-[#10B981] transition-colors">
            ...
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-[#10B981] transition-colors">
            ...
            <a href="https://facebook.com/GlobalLeadershipMakers" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-[#10B981] transition-colors">
      ...
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-indigo-400/20 flex flex-col items-center space-y-4">
        ...
        <p className="text-xs text-slate-400/80 font-light tracking-wide">
