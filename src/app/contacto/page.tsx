    ...
    <div className="bg-white min-h-[80vh]">
      <section className="py-24 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto grid md:grid-cols-2 gap-16">
        ...
        >
          ...
          <div className="space-y-6">
             <div className="flex items-center space-x-4">
               ...
               <div>
                 <p className="font-bold text-[#1E3A8A]">Correo Electrónico</p>
             ...
             <div className="flex items-center space-x-4">
               ...
               <div>
                 <p className="font-bold text-[#1E3A8A]">Nuestra Base</p>
        ...
        <motion.div
          ...
          variants={fadeInUp}
        >
          <Card variant="solid" className="p-8 border-[#1E3A8A]/10 shadow-lg">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#1E3A8A]/20 focus:border-[#1E3A8A] transition-all bg-gray-50/50"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#1E3A8A]/20 focus:border-[#1E3A8A] transition-all bg-gray-50/50 resize-none"
              ...
              <button
                ...
                className={`w-full py-4 rounded-xl text-white font-bold text-lg flex items-center justify-center space-x-2 transition-all duration-300 ${status === "sent" ? "bg-[#10B981]" : "bg-[#1E3A8A] hover:bg-[#10B981]"}`}
              >
          ...
          >
            {["Postula al equipo CORE", "Sé Embajador VIP", "Conviértete en Embajador", "Únete como Voluntario"].map((role, i) => (
              <motion.div key={i} variants={fadeInUp}>
                <Card variant="glass" hoverable className="h-full p-8 text-center flex flex-col justify-center items-center cursor-pointer border-[#1E3A8A]/10 group">
                  <h3 className="text-xl font-bold text-[#1E3A8A] mb-4 group-hover:text-[#10B981] transition-colors">{role}</h3>
